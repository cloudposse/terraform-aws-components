...
<dl>
  <dt>`delegated_roles_config` <i>required</i></dt>
  <dd>
  ...
  <dt>`primary_roles_config` <i>required</i></dt>
  <dd>
    A roles map to configure the accounts.<br/>
...
<dl>
  ...
  <dt>`sso_environment_name` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`sso_stage_name` (`string`) <i>optional</i></dt>
  <dd>

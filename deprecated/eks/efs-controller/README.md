...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_efs"></a> [efs](#module\_efs) | cloudposse/stack-config/yaml//modules/remote-state | 1.4.1 |
| <a name="module_efs_controller"></a> [efs\_controller](#module\_efs\_controller) | cloudposse/helm-release/aws | 0.11.0 |

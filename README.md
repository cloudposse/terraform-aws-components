...
No two companies will ever have the same assembly of `terraform-aws-components`.

The root modules are the most opinionated incarnations of modules that seldom translate verbatim across organizations. This is your secret sauce. We could never implement this in a sufficiently generic way without creating crazy bloat and complexity. Therefore treat the terraform-aws-components in this repository as your “starting off point” where you hardfork/diverge.
...
These `terraform-aws-components` make a lot of assumptions about how we've configured our environments. That said, they can still serve as an excellent reference for others.
...
File a GitHub [issue](https://github.com/cloudposse/terraform-aws-components/issues), send us an [email][email] or join our [Slack Community][slack].

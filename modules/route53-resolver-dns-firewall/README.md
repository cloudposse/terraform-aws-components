...
`route53_resolver_dns_firewall` | [![0.2.1](https://img.shields.io/badge/0.2.1-success.svg?style=for-the-badge)]([`cloudposse/route53-resolver-dns-firewall/aws`](https://registry.terraform.io/modules/cloudposse/route53-resolver-dns-firewall/aws/0.2.1)) | [`cloudposse/route53-resolver-dns-firewall/aws`](https://registry.terraform.io/modules/cloudposse/route53-resolver-dns-firewall/aws/0.2.1) | n/a
...
### `rule_groups_config` <i>required</i>
...
### `logs_bucket_component_name` (`string`) <i>optional</i>
...
### `query_log_config_name` (`string`) <i>optional</i>
...
### `query_log_enabled` (`bool`) <i>optional</i>

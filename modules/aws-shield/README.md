...
The following resources are used by this module:
  ...
  - [`aws_shield_protection.alb_shield_protection`](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/shield_protection) (resource)(alb.tf#7)
  - [`aws_shield_protection.cloudfront_shield_protection`](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/shield_protection) (resource)(cloudfront.tf#7)
  - [`aws_shield_protection.eip_shield_protection`](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/shield_protection) (resource)(eip.tf#7)
  - [`aws_shield_protection.route53_zone_protection`](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/shield_protection) (resource)(route53.tf#7)
...
## Optional Variables
### `alb_names` (`list(string)`) <i>optional</i>
...
### `alb_protection_enabled` (`bool`) <i>optional</i>
...
### `cloudfront_distribution_ids` (`list(string)`) <i>optional</i>
...
### `route53_zone_names` (`list(string)`) <i>optional</i>

...
<dl>
  <dt>`enable_lifecycle_policy` (`bool`) <i>required</i></dt>
  <dd>
  ...
  <dt>`images` (`list(string)`) <i>required</i></dt>
  <dd>
  ...
  <dt>`max_image_count` (`number`) <i>required</i></dt>
  <dd>
  ...
  <dt>`read_write_account_role_map` (`map(list(string))`) <i>required</i></dt>
  <dd>
...
<dl>
  <dt>`ecr_user_enabled` (`bool`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`image_tag_mutability` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`principals_lambda` (`list(string)`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`protected_tags` (`list(string)`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`read_only_account_role_map` (`map(list(string))`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`scan_images_on_push` (`bool`) <i>optional</i></dt>
  <dd>
...
<dl>
  <dt>`ecr_repo_arn_map`</dt>
  <dd>
    Map of image names to ARNs<br/>
  </dd>
  <dt>`ecr_repo_url_map`</dt>
  <dd>
  ...
  <dt>`ecr_user_unique_id`</dt>
  <dd>
    ECR user unique ID assigned by AWS<br/>
  </dd>
  <dt>`repository_host`</dt>
  <dd>

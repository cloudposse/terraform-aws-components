...
--- | --- | --- | ---
`ecr` | [![0.36.0](https://img.shields.io/badge/0.36.0-success.svg?style=for-the-badge)]([`cloudposse/ecr/aws`](https://registry.terraform.io/modules/cloudposse/ecr/aws/0.36.0)) | [`cloudposse/ecr/aws`](https://registry.terraform.io/modules/cloudposse/ecr/aws/0.36.0) | n/a
`full_access` | [![latest](https://img.shields.io/badge/latest-success.svg?style=for-the-badge)]([`../account-map/modules/roles-to-principals`](../account-map/modules/roles-to-principals)) | [`../account-map/modules/roles-to-principals`](../account-map/modules/roles-to-principals) | n/a
...
`readonly_access` | [![latest](https://img.shields.io/badge/latest-success.svg?style=for-the-badge)]([`../account-map/modules/roles-to-principals`](../account-map/modules/roles-to-principals)) | [`../account-map/modules/roles-to-principals`](../account-map/modules/roles-to-principals) | n/a
...
The following resources are used by this module:
  ...
  - [`aws_iam_policy.ecr_user`](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_policy) (resource)(user.tf#22)
  - [`aws_iam_user.ecr`](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_user) (resource)(user.tf#5)
  - [`aws_iam_user_policy_attachment.ecr_user`](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_user_policy_attachment) (resource)(user.tf#28)
...
Enable/disable image lifecycle policy<br/>
...
### `images` (`list(string)`) <i>required</i>


List of image names (ECR repo names) to create repos for<br/>
...
### `max_image_count` (`number`) <i>required</i>


Max number of images to store. Old ones will be deleted to make room for new ones.<br/>
...
### `read_write_account_role_map` (`map(list(string))`) <i>required</i>


Map of `account:[role, role...]` for write access. Use `*` for role to grant access to entire account<br/>
...
## Optional Variables
### `ecr_user_enabled` (`bool`) <i>optional</i>


Enable/disable the provisioning of the ECR user (for CI/CD systems that don't support assuming IAM roles to access ECR, e.g. Codefresh)<br/>
...
### `image_tag_mutability` (`string`) <i>optional</i>


The tag mutability setting for the repository. Must be one of: `MUTABLE` or `IMMUTABLE`<br/>
...
### `principals_lambda` (`list(string)`) <i>optional</i>


Principal account IDs of Lambdas allowed to consume ECR<br/>
...
### `protected_tags` (`list(string)`) <i>optional</i>


Tags to refrain from deleting<br/>
...
### `read_only_account_role_map` (`map(list(string))`) <i>optional</i>


Map of `account:[role, role...]` for read-only access. Use `*` for role to grant access to entire account<br/>
...
### `scan_images_on_push` (`bool`) <i>optional</i>


Indicates whether images are scanned after being pushed to the repository<br/>

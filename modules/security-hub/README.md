...
<dl>
  ...
  <dt>`auto_enable_organization_members` (`bool`) <i>optional</i></dt>
  <dd>
  ...
  <dd>
    ...
    **Type:** `string`
    <br/>
    **Default value:** `"ecurity Hub Findings - Imported"`
  </dd>
  ...
  <dt>`default_standards_enabled` (`bool`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`finding_aggregation_region` (`string`) <i>optional</i></dt>
  <dd>

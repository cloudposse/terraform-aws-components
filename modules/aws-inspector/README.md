...
The short form of the rules is expected for the `enabled_rules` key since it will automatically retrieve the appropriate arn in the region used. The list of short forms are documented for the [`var.enabled_rules`](https://github.com/cloudposse/terraform-aws-inspector#input_enabled_rules) input.

Full list of rules can be found in [Amazon Inspector ARNS for rules packages](https://docs.aws.amazon.com/inspector/latest/userguide/inspector_rules-arns.html).

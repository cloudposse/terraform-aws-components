...
| [terraform_remote_state.cloudtrail_bucket](https://registry.terraform.io/providers/hashicorp/terraform/latest/docs/data-sources/remote_state) | data source |
...
| <a name="input_cloudtrail_bucket_stage_name"></a> [cloudtrail\_bucket\_stage\_name](#input\_cloudtrail\_bucket\_stage\_name) | The stage (account) name where the CloudTrail bucket is provisioned | `string` | `"audit"` | no |

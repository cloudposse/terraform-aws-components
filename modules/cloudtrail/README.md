...
| <a name="input_account_map_privileged"></a> [account\_map\_privileged](#input\_account\_map\_privileged) | True if the caller already has access to the backend without assuming roles | `bool` | `false` | no |

...
<dl>
  ...
  <dt>`additional_schemas` <i>optional</i></dt>
  <dd>
  ...
  <dt>`aurora_postgres_component_name` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`cluster_enabled` (`string`) <i>optional</i></dt>
  <dd>
    Set to `false` to prevent the module from creating any resources<br/>
    <br/>
    **Type:** `string`
  ...
  <dt>`db_name` (`string`) <i>optional</i></dt>
  <dd>

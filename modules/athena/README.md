...
`athena` | [![0.1.1](https://img.shields.io/badge/0.1.1-success.svg?style=for-the-badge)]([`cloudposse/athena/aws`](https://registry.terraform.io/modules/cloudposse/athena/aws/0.1.1)) | [`cloudposse/athena/aws`](https://registry.terraform.io/modules/cloudposse/athena/aws/0.1.1) | n/a
...
### `athena_kms_key_deletion_window` (`number`) <i>optional</i>
...
### `athena_s3_bucket_id` (`string`) <i>optional</i>
...
### `bytes_scanned_cutoff_per_query` (`number`) <i>optional</i>
...
### `cloudtrail_database` (`string`) <i>optional</i>
...
### `create_kms_key` (`bool`) <i>optional</i>
...
### `data_catalogs` (`map(any)`) <i>optional</i>
...
### `enforce_workgroup_configuration` (`bool`) <i>optional</i>
...
### `named_queries` (`map(map(string))`) <i>optional</i>
...
### `publish_cloudwatch_metrics_enabled` (`bool`) <i>optional</i>
...
### `s3_output_path` (`string`) <i>optional</i>
...
### `workgroup_description` (`string`) <i>optional</i>
...
### `workgroup_encryption_option` (`string`) <i>optional</i>
...
### `workgroup_force_destroy` (`bool`) <i>optional</i>
...
### `workgroup_state` (`string`) <i>optional</i>

...
`managed_prometheus` | 0.1.1 | [`cloudposse/managed-prometheus/aws`](https://registry.terraform.io/modules/cloudposse/managed-prometheus/aws/0.1.1) | n/a
...
<dl>
  ...
  <dt>`alert_manager_definition` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`grafana_account_name` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`rule_group_namespaces` <i>optional</i></dt>
  <dd>
  ...
  <dt>`vpc_endpoint_enabled` (`string`) <i>optional</i></dt>
  <dd>

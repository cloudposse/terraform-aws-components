...
`managed_prometheus` | [![0.1.1](https://img.shields.io/badge/0.1.1-success.svg?style=for-the-badge)]([`cloudposse/managed-prometheus/aws`](https://registry.terraform.io/modules/cloudposse/managed-prometheus/aws/0.1.1)) | [`cloudposse/managed-prometheus/aws`](https://registry.terraform.io/modules/cloudposse/managed-prometheus/aws/0.1.1) | n/a
...
### `alert_manager_definition` (`string`) <i>optional</i>


The alert manager definition that you want to be applied.<br/>
...
### `grafana_account_name` (`string`) <i>optional</i>


The name of the account allowed to access AMP in this account. If defined, this module will create a cross-account IAM role for accessing AMP. Use this for cross-account Grafana. If not defined, no roles will be created.<br/>
...
### `rule_group_namespaces` <i>optional</i>


A list of name, data objects for each Amazon Managed Service for Prometheus (AMP) Rule Group Namespace<br/>
...
### `vpc_endpoint_enabled` (`string`) <i>optional</i>


If set to `true`, restrict traffic through a VPC endpoint<br/>

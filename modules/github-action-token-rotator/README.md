...
--- | --- | --- | ---
`github_action_token_rotator` | [![0.1.0](https://img.shields.io/badge/0.1.0-success.svg?style=for-the-badge)]([`cloudposse/github-action-token-rotator/aws`](https://registry.terraform.io/modules/cloudposse/github-action-token-rotator/aws/0.1.0)) | [`cloudposse/github-action-token-rotator/aws`](https://registry.terraform.io/modules/cloudposse/github-action-token-rotator/aws/0.1.0) | n/a
...
>
### `github_app_id` (`string`) <i>required</i>
...
### `github_app_installation_id` (`string`) <i>required</i>


GitHub App Installation ID<br/>
...
### `github_org_name` (`string`) <i>required</i>
...
### `parameter_store_private_key_path` (`string`) <i>required</i>


Path to read the GitHub App private key from parameter store<br/>
...
### `parameter_store_token_path` (`string`) <i>required</i>


Path to store the token in parameter store<br/>

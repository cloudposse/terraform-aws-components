...
<dl>
  <dt>`github_app_id` (`string`) <i>required</i></dt>
  <dd>
    GitHub App ID<br/>
  ...
  <dt>`github_app_installation_id` (`string`) <i>required</i></dt>
  <dd>
  ...
  <dt>`github_org_name` (`string`) <i>required</i></dt>
  <dd>
  ...
  <dt>`parameter_store_private_key_path` (`string`) <i>required</i></dt>
  <dd>
  ...
  <dt>`parameter_store_token_path` (`string`) <i>required</i></dt>
  <dd>
...
<dl>
  <dt>`github_action_token_rotator`</dt>
  <dd>

  ...
  terraform:
    gha-service-roles/example:
      ...
      vars:
        github_actions_allowed_repos:
          - MyOrg/MyRepo
        github_actions_iam_role_attributes: [ "example" ] # adds "example" to the role name
        aws_iam_policy_statements:
          - Sid: "AllowAll"
            Action: [
              "lambda:*",
            ]
...
| <a name="input_aws_iam_policy_statements"></a> [aws\_iam\_policy\_statements](#input\_aws\_iam\_policy\_statements) | n/a | `list(any)` | `[]` | no |

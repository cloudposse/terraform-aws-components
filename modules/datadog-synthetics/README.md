...
<dl>
  ...
  <dt>`synthetics_paths` (`list(string)`) <i>required</i></dt>
  <dd>
...
<dl>
  <dt>`alert_tags` (`list(string)`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`alert_tags_separator` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`config_parameters` (`map(any)`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`datadog_synthetics_globals` (`any`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`locations` (`list(string)`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`private_location_test_enabled` (`bool`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`synthetics_private_location_component_name` (`string`) <i>optional</i></dt>
  <dd>

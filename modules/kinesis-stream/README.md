...
`kinesis` | [![0.3.0](https://img.shields.io/badge/0.3.0-success.svg?style=for-the-badge)]([`cloudposse/kinesis-stream/aws`](https://registry.terraform.io/modules/cloudposse/kinesis-stream/aws/0.3.0)) | [`cloudposse/kinesis-stream/aws`](https://registry.terraform.io/modules/cloudposse/kinesis-stream/aws/0.3.0) | n/a
...
## Optional Variables
### `consumer_count` (`number`) <i>optional</i>


Number of consumers to register with the Kinesis stream.<br/>
...
### `encryption_type` (`string`) <i>optional</i>


The encryption type to use. Acceptable values are `NONE` and `KMS`.<br/>
...
### `enforce_consumer_deletion` (`bool`) <i>optional</i>


Forcefully delete stream consumers before destroying the stream.<br/>
...
The name of the KMS key to use for encryption.<br/>
...
Length of time data records are accessible after they are added to the stream. The maximum value is 168 hours. Minimum value is 24.<br/>
...
The number of shards to provision for the stream.<br/>
...
A list of shard-level CloudWatch metrics to enabled for the stream.<br/>
...
Specifies the capacity mode of the stream. Must be either `PROVISIONED` or `ON_DEMAND`.<br/>

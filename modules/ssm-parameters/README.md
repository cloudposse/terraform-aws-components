...
- [`sops`](https://registry.terraform.io/modules/sops/>= 0.5, < 1.0), version: >= 0.5, < 1.0
...
<dl>
  <dt>`kms_arn` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`sops_source_file` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`sops_source_key` (`string`) <i>optional</i></dt>
  <dd>

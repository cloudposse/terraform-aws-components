...
| `sops` | ![>= 0.5, < 1.0](https://img.shields.io/badge/>=_0.5,_<_1.0-success.svg?style=for-the-badge) |
...
| [`sops`](https://registry.terraform.io/providers/sops/latest) | ![>= 0.5, < 1.0](https://img.shields.io/badge/>=_0.5,_<_1.0-success.svg?style=for-the-badge) |
...
The following resources are used by this module:
  ...
  - [`aws_ssm_parameter.destination`](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/ssm_parameter) (resource)(main.tf#28)
...
A map of parameter values to write to SSM Parameter Store<br/>
...
## Optional Variables
### `kms_arn` (`string`) <i>optional</i>


The ARN of a KMS key used to encrypt and decrypt SecretString values<br/>
...
### `sops_source_file` (`string`) <i>optional</i>


The relative path to the SOPS file which is consumed as the source for creating parameter resources.<br/>
...
### `sops_source_key` (`string`) <i>optional</i>


The SOPS key to pull from the source file.<br/>

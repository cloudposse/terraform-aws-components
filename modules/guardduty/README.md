...
| <a name="input_auto_enable_guardduty_organization_features"></a> [auto\_enable\_guardduty\_organization\_features](#input\_auto\_enable\_guardduty\_organization\_features) | A flag to indicate whether GuardDuty organization features should be auto-enabled"<br>Valid values are `ALL`, `NEW`, `NONE`. | `string` | `"NONE"` | no |
| <a name="input_auto_enable_guardduty_organization_features_additional_configurations"></a> [auto\_enable\_guardduty\_organization\_features\_additional\_configurations](#input\_auto\_enable\_guardduty\_organization\_features\_additional\_configurations) | A flag to indicate whether GuardDuty organization feature's additional configuration should be auto-enabled<br>Valid values are `ALL`, `NEW`, `NONE`. | `string` | `"NONE"` | no |
...
| <a name="input_eks_runtime_monitoring_enabled"></a> [eks\_runtime\_monitoring\_enabled](#input\_eks\_runtime\_monitoring\_enabled) | Enables EKS runtime monitoring as a feature for EKS protection | `bool` | `false` | no |
...
| <a name="input_kubernetes_audit_logs_enabled"></a> [kubernetes\_audit\_logs\_enabled](#input\_kubernetes\_audit\_logs\_enabled) | Enables Kubernetes audit logs as a feature for Kubernetes protection | `bool` | `false` | no |
...
| <a name="input_lambda_network_logs_enabled"></a> [lambda\_network\_logs\_enabled](#input\_lambda\_network\_logs\_enabled) | Enables Lambda network logs as a feature for Lambda protection | `bool` | `false` | no |
| <a name="input_malware_protection_scan_ec2_ebs_volumes_enabled"></a> [malware\_protection\_scan\_ec2\_ebs\_volumes\_enabled](#input\_malware\_protection\_scan\_ec2\_ebs\_volumes\_enabled) | Enables EBS malware protection as a feature for EC2 protection | `bool` | `false` | no |
...
| <a name="input_rds_login_events_enabled"></a> [rds\_login\_events\_enabled](#input\_rds\_login\_events\_enabled) | Enables RDS login events as a feature for RDS protection | `bool` | `false` | no |
...
| <a name="input_runtime_monitoring_enabled"></a> [runtime\_monitoring\_enabled](#input\_runtime\_monitoring\_enabled) | Enables runtime monitoring as a feature for ECS, EKS, and EC2 protection | `bool` | `false` | no |

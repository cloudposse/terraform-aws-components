...
`kms_key_logs` | 0.12.1 | [`cloudposse/kms-key/aws`](https://registry.terraform.io/modules/cloudposse/kms-key/aws/0.12.1) | n/a
`logs` | 0.6.5 | [`cloudposse/cloudwatch-logs/aws`](https://registry.terraform.io/modules/cloudposse/cloudwatch-logs/aws/0.6.5) | n/a
...
<dl>
  <dt>`additional_permissions` (`list(string)`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`principals` (`map(any)`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`retention_in_days` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`stream_names` (`list(string)`) <i>optional</i></dt>
  <dd>
    Names of streams<br/>
    <br/>
    **Type:** `list(string)`

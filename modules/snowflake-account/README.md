...
<dl>
  ...
  <dt>`snowflake_account` (`string`) <i>required</i></dt>
  <dd>
  ...
  <dt>`snowflake_account_region` (`string`) <i>required</i></dt>
  <dd>
...
<dl>
  <dt>`default_warehouse_size` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`root_account_stage_name` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`service_user_id` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`snowflake_admin_username` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`snowflake_role_description` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`snowflake_username_format` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`ssm_path_snowflake_user_format` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`terraform_user_first_name` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`terraform_user_last_name` (`string`) <i>optional</i></dt>
  <dd>

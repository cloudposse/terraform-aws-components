  ...
  terraform:
    iam-primary-roles:
      ...
      vars:
        ...
        # Historically there was a practical difference between the two, but now it is just for documentation.
...
| <a name="module_assume_role"></a> [assume\_role](#module\_assume\_role) | ../iam-delegated-roles/modules/iam-assume-role-policy | n/a |

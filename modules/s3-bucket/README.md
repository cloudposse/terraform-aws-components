...
| <a name="input_custom_policy_enabled"></a> [custom\_policy\_enabled](#input\_custom\_policy\_enabled) | Whether to enable or disable the custom policy. Conflicts with `var.log_delivery_policy_enabled` | `bool` | `false` | no |
...
| <a name="input_log_delivery_policy_enabled"></a> [log\_delivery\_policy\_enabled](#input\_log\_delivery\_policy\_enabled) | Whether to enable or disable the log delivery policy. Conflicts with `var.custom_policy_enabled` | `bool` | `false` | no |

...
<dl>
  ...
  <dt>`teams_config` <i>required</i></dt>
  <dd>
...
<dl>
  ...
  <dt>`aws_saml_environment_name` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`aws_saml_stage_name` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`trusted_github_repos` (`map(list(string))`) <i>optional</i></dt>
  <dd>

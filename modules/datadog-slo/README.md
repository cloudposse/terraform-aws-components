...
| <a name="input_datadog_monitors_config_paths"></a> [datadog\_monitors\_config\_paths](#input\_datadog\_monitors\_config\_paths) | List of paths to Datadog monitor configurations | `list(string)` | n/a | yes |

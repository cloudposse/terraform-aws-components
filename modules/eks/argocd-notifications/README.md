...
This component creates a Helm release for [argocd-notifications](https://github.com/argoproj-labs/applicationset) on a Kubernetes cluster.

This component is meant to be deployed alongside the [argocd component](../argocd).
...
```yaml
import:
  - catalog/eks/argocd-notifications
  ...
```

The default catalog values `e.g. stacks/catalog/eks/argocd-notifications.yaml`
...
components:
  terraform:
    argocd-notifications:
      backend:
        s3:
          workspace_key_prefix: argocd-notifications
      vars:
        enabled: true
        slack_notifications_enabled: true
        slack_notifications_username: "ACME Bot"
        slack_notifications_icon: "https://avatars.githubusercontent.com/u/12345678?v=4"
        github_notifications_enabled: true
        notifications_triggers: {} # see variable documentation
        notifications_templates: {} # see variable documentation
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_argocd"></a> [argocd](#module\_argocd) | cloudposse/stack-config/yaml//modules/remote-state | 0.22.1 |
| <a name="module_argocd_notifications"></a> [argocd\_notifications](#module\_argocd\_notifications) | cloudposse/helm-release/aws | 0.3.0 |

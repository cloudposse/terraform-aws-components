...
`dns_gbl_primary` | 1.5.0 | [`cloudposse/stack-config/yaml//modules/remote-state`](https://registry.terraform.io/modules/cloudposse/stack-config/yaml/1.5.0/submodules/remote-state) | n/a
...
### `dns_gbl_primary_environment_name` (`string`) <i>optional</i>
...
### `istio_enabled` (`bool`) <i>optional</i>
...
### `publish_internal_services` (`bool`) <i>optional</i>
...
### `txt_prefix` (`string`) <i>optional</i>

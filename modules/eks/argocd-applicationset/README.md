...
This component creates a Helm release for [argocd-applicationset](https://github.com/argoproj-labs/applicationset) on a Kubernetes cluster.
...
```yaml
import:
  - catalog/eks/argocd-applicationset
  ...
```

The default catalog values `e.g. stacks/catalog/eks/argocd-applicationset.yaml`
...
components:
  terraform:
    argocd-applicationset:
      backend:
        s3:
          workspace_key_prefix: argocd-applicationset
      vars:
        enabled: true
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_argocd_applicationset"></a> [argocd\_applicationset](#module\_argocd\_applicationset) | cloudposse/helm-release/aws | 0.3.0 |

...
| [`kubernetes`](https://registry.terraform.io/providers/kubernetes/latest) | >= 2.14.0, != 2.21.0 |
...
### `class_name` (`string`) <i>optional</i>
...
### `load_balancer_attributes` (`list(object({ key = string, value = string }))`) <i>optional</i>

...
--- | --- | --- | ---
`alb_controller` | 0.10.0 | [`cloudposse/helm-release/aws`](https://registry.terraform.io/modules/cloudposse/helm-release/aws/0.10.0) | n/a
...
<dl>
  ...
  <dt>`default_ingress_additional_tags` (`map(string)`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`default_ingress_class_name` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`default_ingress_enabled` (`bool`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`default_ingress_group` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`default_ingress_ip_address_type` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`default_ingress_load_balancer_attributes` (`list(object({ key = string, value = string }))`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`default_ingress_scheme` (`string`) <i>optional</i></dt>
  <dd>

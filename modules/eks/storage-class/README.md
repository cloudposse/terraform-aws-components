...
- [`kubernetes`](https://registry.terraform.io/modules/kubernetes/>= 2.22.0), version: >= 2.22.0
...
<dl>
  <dt>`ebs_storage_classes` <i>optional</i></dt>
  <dd>
  ...
  <dt>`efs_storage_classes` <i>optional</i></dt>
  <dd>

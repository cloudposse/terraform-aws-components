...
- [`http`](https://registry.terraform.io/modules/http/>= 3.4.2), version: >= 3.4.2
...
<dl>
  <dt>`dashboard_name` (`string`) <i>required</i></dt>
  <dd>
  ...
  <dt>`dashboard_url` (`string`) <i>required</i></dt>
  <dd>
...
<dl>
  <dt>`additional_config` (`map(any)`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`config_input` (`map(string)`) <i>optional</i></dt>
  <dd>

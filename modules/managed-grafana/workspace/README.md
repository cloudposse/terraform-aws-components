...
<dl>
  <dt>`private_network_access_enabled` (`bool`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`prometheus_policy_enabled` (`bool`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`prometheus_source_accounts` <i>optional</i></dt>
  <dd>
  ...
  <dt>`sso_role_associations` <i>optional</i></dt>
  <dd>

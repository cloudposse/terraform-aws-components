...
<dl>
  <dt>`primary_tgw_hub_region` (`string`) <i>required</i></dt>
  <dd>
...
<dl>
  ...
  <dt>`env_naming_convention` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`primary_tgw_hub_stage` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`primary_tgw_hub_tenant` (`string`) <i>optional</i></dt>
  <dd>

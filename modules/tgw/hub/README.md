...
`tgw_hub` | [![0.11.0](https://img.shields.io/badge/0.11.0-success.svg?style=for-the-badge)](https://registry.terraform.io/modules/cloudposse/transit-gateway/aws/0.11.0) | [`cloudposse/transit-gateway/aws`](https://registry.terraform.io/modules/cloudposse/transit-gateway/aws/0.11.0) | n/a
...
### `allow_external_principals` (`bool`) <i>optional</i>
...
### `ram_principals` (`list(string)`) <i>optional</i>

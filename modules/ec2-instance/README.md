...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_ec2-instance"></a> [ec2-instance](#module\_ec2-instance) | cloudposse/ec2-instance/aws | 1.4.0 |
...
| <a name="input_ami_filters"></a> [ami\_filters](#input\_ami\_filters) | n/a | <pre>list(object({<br>    name   = string<br>    values = list(string)<br>  }))</pre> | <pre>[<br>  {<br>    "name": "architecture",<br>    "values": [<br>      "x86_64"<br>    ]<br>  },<br>  {<br>    "name": "virtualization-type",<br>    "values": [<br>      "hvm"<br>    ]<br>  }<br>]</pre> | no |

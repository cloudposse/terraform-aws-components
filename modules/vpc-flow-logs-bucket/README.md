...
<dl>
  ...
  <dt>`lifecycle_prefix` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`lifecycle_tags` (`map(string)`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`traffic_type` (`string`) <i>optional</i></dt>
  <dd>
...
<dl>
  <dt>`vpc_flow_logs_bucket_arn`</dt>
  <dd>
    VPC Flow Logs bucket ARN<br/>
  </dd>
  <dt>`vpc_flow_logs_bucket_id`</dt>
  <dd>

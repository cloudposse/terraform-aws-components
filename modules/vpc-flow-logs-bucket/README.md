...
--- | --- | --- | ---
`flow_logs_s3_bucket` | [![1.0.1](https://img.shields.io/badge/1.0.1-success.svg?style=for-the-badge)](https://registry.terraform.io/modules/cloudposse/vpc-flow-logs-s3-bucket/aws/1.0.1) | [`cloudposse/vpc-flow-logs-s3-bucket/aws`](https://registry.terraform.io/modules/cloudposse/vpc-flow-logs-s3-bucket/aws/1.0.1) | n/a

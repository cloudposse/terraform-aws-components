...
- [`local`](https://registry.terraform.io/modules/local/>= 2.4.0), version: >= 2.4.0
...
<dl>
  <dt>`create_service_linked_role_spot` (`bool`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`enable_update_github_app_webhook` (`bool`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`github_app_id_ssm_path` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`github_app_key_ssm_path` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`instance_target_capacity_type` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`release_version` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`runner_extra_labels` (`list(string)`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`scale_up_reserved_concurrent_executions` (`number`) <i>optional</i></dt>
  <dd>

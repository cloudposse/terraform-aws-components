...
<dl>
  <dt>`team_name` (`string`) <i>required</i></dt>
  <dd>
  ...
  <dt>`type` (`string`) <i>required</i></dt>
  <dd>
...
<dl>
  <dt>`append_datadog_tags_enabled` (`bool`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`ssm_path_format` (`string`) <i>optional</i></dt>
  <dd>

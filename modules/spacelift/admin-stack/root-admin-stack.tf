...
module "root_admin_stack" {
  ...
  context_attachments                     = try(local.root_admin_stack_config.context_attachments, var.context_attachments)
  ...
  terraform_smart_sanitization            = try(local.root_admin_stack_config.terraform_smart_sanitization, var.terraform_smart_sanitization)

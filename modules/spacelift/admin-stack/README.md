...
--- | --- | --- | ---
`all_admin_stacks_config` | [![1.5.0](https://img.shields.io/badge/1.5.0-success.svg?style=for-the-badge)]([`cloudposse/cloud-infrastructure-automation/spacelift//modules/spacelift-stacks-from-atmos-config`](https://registry.terraform.io/modules/cloudposse/cloud-infrastructure-automation/spacelift/1.5.0/submodules/spacelift-stacks-from-atmos-config)) | [`cloudposse/cloud-infrastructure-automation/spacelift//modules/spacelift-stacks-from-atmos-config`](https://registry.terraform.io/modules/cloudposse/cloud-infrastructure-automation/spacelift/1.5.0/submodules/spacelift-stacks-from-atmos-config) | This gets the atmos stack config for all of the administrative stacks
`child_stack` | [![1.6.0](https://img.shields.io/badge/1.6.0-success.svg?style=for-the-badge)]([`cloudposse/cloud-infrastructure-automation/spacelift//modules/spacelift-stack`](https://registry.terraform.io/modules/cloudposse/cloud-infrastructure-automation/spacelift/1.6.0/submodules/spacelift-stack)) | [`cloudposse/cloud-infrastructure-automation/spacelift//modules/spacelift-stack`](https://registry.terraform.io/modules/cloudposse/cloud-infrastructure-automation/spacelift/1.6.0/submodules/spacelift-stack) | n/a

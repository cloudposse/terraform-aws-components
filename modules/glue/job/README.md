...
`glue_job_s3_bucket` | 1.5.0 | [`cloudposse/stack-config/yaml//modules/remote-state`](https://registry.terraform.io/modules/cloudposse/stack-config/yaml/modules/remote-state/1.5.0) | n/a
...
<dl>
  <dt>`command` (`map(any)`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`connections` (`list(string)`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`default_arguments` (`map(string)`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`execution_property` <i>optional</i></dt>
  <dd>
  ...
  <dt>`glue_job_command_name` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`glue_job_command_python_version` (`number`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`glue_job_s3_bucket_component_name` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`glue_job_s3_bucket_script_path` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`glue_version` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`job_description` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`job_name` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`max_capacity` (`number`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`max_retries` (`number`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`non_overridable_arguments` (`map(string)`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`notification_property` <i>optional</i></dt>
  <dd>
  ...
  <dt>`number_of_workers` (`number`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`security_configuration` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`worker_type` (`string`) <i>optional</i></dt>
  <dd>

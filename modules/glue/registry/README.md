...
--- | --- | --- | ---
`glue_registry` | [![0.4.0](https://img.shields.io/badge/0.4.0-success.svg?style=for-the-badge)](https://registry.terraform.io/modules/cloudposse/glue/aws/0.4.0/submodules/glue-registry) | [`cloudposse/glue/aws//modules/glue-registry`](https://registry.terraform.io/modules/cloudposse/glue/aws/0.4.0/submodules/glue-registry) | n/a
...
## Optional Variables
### `registry_description` (`string`) <i>optional</i>


Glue registry description<br/>
...
### `registry_name` (`string`) <i>optional</i>


Glue registry name. If not provided, the name will be generated from the context<br/>

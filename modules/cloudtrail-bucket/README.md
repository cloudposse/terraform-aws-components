...
--- | --- | --- | ---
`cloudtrail_s3_bucket` | [![0.26.1](https://img.shields.io/badge/0.26.1-success.svg?style=for-the-badge)]([`cloudposse/cloudtrail-s3-bucket/aws`](https://registry.terraform.io/modules/cloudposse/cloudtrail-s3-bucket/aws/0.26.1)) | [`cloudposse/cloudtrail-s3-bucket/aws`](https://registry.terraform.io/modules/cloudposse/cloudtrail-s3-bucket/aws/0.26.1) | n/a
...
## Optional Variables
### `access_log_bucket_name` (`string`) <i>optional</i>
...
>   <dt>Default value</dt>
>   <dd>
>   <code>"log-delivery-write"</code>
>   </dd>
> </dl>
>


### `create_access_log_bucket` (`bool`) <i>optional</i>

...
| <a name="input_bucket_enabled"></a> [bucket\_enabled](#input\_bucket\_enabled) | Create a new S3 bucket for this SFTP server if true - set s3\_bucket\_name to an existing bucket otherwise | `bool` | n/a | yes |

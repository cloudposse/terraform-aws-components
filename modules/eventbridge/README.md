...
<dl>
  <dt>`cloudwatch_event_rule_description` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`cloudwatch_event_rule_pattern` (`any`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`event_log_retention_in_days` (`number`) <i>optional</i></dt>
  <dd>
...
<dl>
  <dt>`cloudwatch_event_rule_arn`</dt>
  <dd>
    The ARN of the CloudWatch Event Rule<br/>
  </dd>
  <dt>`cloudwatch_event_rule_name`</dt>
  <dd>
    The name of the CloudWatch Event Rule<br/>
  </dd>
  <dt>`cloudwatch_logs_log_group_arn`</dt>
  <dd>
    The ARN of the CloudWatch Log Group<br/>
  </dd>
  <dt>`cloudwatch_logs_log_group_name`</dt>
  <dd>

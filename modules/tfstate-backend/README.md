...
<dl>
  <dt>`access_roles` <i>optional</i></dt>
  <dd>
  ...
  <dt>`access_roles_enabled` (`bool`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`enable_point_in_time_recovery` (`bool`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`enable_server_side_encryption` (`bool`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`prevent_unencrypted_uploads` (`bool`) <i>optional</i></dt>
  <dd>
...
<dl>
  <dt>`tfstate_backend_access_role_arns`</dt>
  <dd>
    IAM Role ARNs for accessing the Terraform State Backend<br/>
  </dd>
  <dt>`tfstate_backend_dynamodb_table_arn`</dt>
  <dd>
    Terraform state DynamoDB table ARN<br/>
  </dd>
  <dt>`tfstate_backend_dynamodb_table_id`</dt>
  <dd>
    Terraform state DynamoDB table ID<br/>
  </dd>
  <dt>`tfstate_backend_dynamodb_table_name`</dt>
  <dd>
    Terraform state DynamoDB table name<br/>
  </dd>
  <dt>`tfstate_backend_s3_bucket_arn`</dt>
  <dd>
    Terraform state S3 bucket ARN<br/>
  </dd>
  <dt>`tfstate_backend_s3_bucket_domain_name`</dt>
  <dd>
    Terraform state S3 bucket domain name<br/>
  </dd>
  <dt>`tfstate_backend_s3_bucket_id`</dt>
  <dd>

...
`ipam` | [![1.2.1](https://img.shields.io/badge/1.2.1-success.svg?style=for-the-badge)]([`aws-ia/ipam/aws`](https://registry.terraform.io/modules/aws-ia/ipam/aws/1.2.1)) | [`aws-ia/ipam/aws`](https://registry.terraform.io/modules/aws-ia/ipam/aws/1.2.1) | n/a
...
### `top_cidr` (`list(string)`) <i>required</i>


Top-level CIDR blocks.<br/>
...
### `address_family` (`string`) <i>optional</i>


IPv4/6 address family.<br/>
...
### `ipam_scope_id` (`string`) <i>optional</i>


(Optional) Required if `var.ipam_id` is set. Determines which scope to deploy pools into.<br/>
...
### `ipam_scope_type` (`string`) <i>optional</i>


Which scope type to use. Valid inputs include `public` or `private`. You can alternatively provide your own scope ID.<br/>
...
### `pool_configurations` (`any`) <i>optional</i>


A multi-level, nested map describing nested IPAM pools. Can nest up to three levels with the top level being outside the `pool_configurations`. This attribute is quite complex, see README.md for further explanation.<br/>
...
### `top_auto_import` (`bool`) <i>optional</i>


`auto_import` setting for top-level pool.<br/>
...
### `top_cidr_authorization_context` (`any`) <i>optional</i>


A signed document that proves that you are authorized to bring the specified IP address range to Amazon using BYOIP. Document is not stored in the state file. For more information, refer to https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/vpc_ipam_pool_cidr#cidr_authorization_context.<br/>
...
### `top_description` (`string`) <i>optional</i>


Description of top-level pool.<br/>
...
### `top_ram_share_principals` (`list(string)`) <i>optional</i>


Principals to create RAM shares for top-level pool.<br/>

...
<dl>
  <dt>`accepter_region` (`string`) <i>required</i></dt>
  <dd>
  ...
  <dt>`accepter_vpc` (`any`) <i>required</i></dt>
  <dd>
...
<dl>
  <dt>`accepter_allow_remote_vpc_dns_resolution` (`bool`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`accepter_aws_assume_role_arn` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`accepter_stage_name` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`auto_accept` (`bool`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`requester_allow_remote_vpc_dns_resolution` (`bool`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`requester_vpc_component_name` (`string`) <i>optional</i></dt>
  <dd>

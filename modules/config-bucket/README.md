...
This component is responsible for creating an S3 bucket suitable for storing AWS Config data.
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_config_s3_bucket"></a> [config\_s3\_bucket](#module\_config\_s3\_bucket) | cloudposse/config-storage/aws | 0.4.0 |
...
| Name | Description |
|------|-------------|
| <a name="output_config_bucket_arn"></a> [config\_bucket\_arn](#output\_config\_bucket\_arn) | Config S3 bucket ARN |
| <a name="output_config_bucket_domain_name"></a> [config\_bucket\_domain\_name](#output\_config\_bucket\_domain\_name) | Config S3 bucket domain name |
| <a name="output_config_bucket_id"></a> [config\_bucket\_id](#output\_config\_bucket\_id) | Config S3 bucket ID |

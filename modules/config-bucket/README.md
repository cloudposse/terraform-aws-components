...
--- | --- | --- | ---
`config_bucket` | [![1.0.2](https://img.shields.io/badge/1.0.2-success.svg?style=for-the-badge)]([`cloudposse/config-storage/aws`](https://registry.terraform.io/modules/cloudposse/config-storage/aws/1.0.2)) | [`cloudposse/config-storage/aws`](https://registry.terraform.io/modules/cloudposse/config-storage/aws/1.0.2) | n/a
...
### `enable_glacier_transition` (`bool`) <i>optional</i>

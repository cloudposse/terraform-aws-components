...
<dl>
  ...
  <dd>
    Name of the S3 bucket where s3 access log will be sent to<br/>
    <br/>
    **Type:** `string`
    <br/>
    **Default value:** `""`
  ...
  <dd>
    The canned ACL to apply. We recommend log-delivery-write for compatibility with AWS services<br/>
    <br/>
    **Type:** `string`
    <br/>
    **Default value:** `"log-delivery-write"`
  </dd>
  <dt>`enable_glacier_transition` (`bool`) <i>optional</i></dt>
  <dd>
    Enables the transition to AWS Glacier (note that this can incur unnecessary costs for huge amount of small files<br/>
    <br/>
    **Type:** `bool`
    <br/>
    **Default value:** `true`
...
<dl>
  <dt>`config_bucket_arn`</dt>
  <dd>
    Config bucket ARN<br/>
  </dd>
  <dt>`config_bucket_domain_name`</dt>
  <dd>
    Config bucket FQDN<br/>
  </dd>
  <dt>`config_bucket_id`</dt>
  <dd>
    Config bucket ID<br/>
  </dd>
</dl>

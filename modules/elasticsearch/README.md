...
| <a name="input_elasticsearch_master_username"></a> [elasticsearch\_master\_username](#input\_elasticsearch\_master\_username) | Master user username | `string` | `"admin"` | no |

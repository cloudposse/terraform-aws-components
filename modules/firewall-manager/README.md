...
This component is responsible for provisioning AWS Firewall Manager Admin Account and related rules.
...
| <a name="module_autoscale_group"></a> [autoscale\_group](#module\_autoscale\_group) | cloudposse/ec2-autoscale-group/aws | 0.14.0 |
| <a name="module_iam_roles"></a> [iam\_roles](#module\_iam\_roles) | ../account-map/modules/iam-roles | n/a |
| <a name="module_sg"></a> [sg](#module\_sg) | cloudposse/security-group/aws | 0.3.1 |
...
| <a name="input_github_scope"></a> [github\_scope](#input\_github\_scope) | GitHub Org or GitHub Org/GitHub Repo i.e cloudposse/atmos | `string` | `null` | no |
...
| <a name="input_runner_version"></a> [runner\_version](#input\_runner\_version) | GitHub runner release version | `string` | `"v2.277.1"` | no |
...
| <a name="input_ssm_path"></a> [ssm\_path](#input\_ssm\_path) | SSM path | `string` | `"github"` | no |

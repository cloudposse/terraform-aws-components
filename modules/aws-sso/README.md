...
| [aws_ssoadmin_instances.org](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/ssoadmin_instances) | data source |
...
| <a name="input_groups"></a> [groups](#input\_groups) | Groups to create in the identity store | <pre>map(object({<br>    display_name = string<br>    description  = string<br>  }))</pre> | <pre>{<br>  "BillingAdmin": {<br>    "description": "Billing Administrators",<br>    "display_name": "BillingAdmin"<br>  },<br>  "DevOps": {<br>    "description": "DevOps Team",<br>    "display_name": "DevOps"<br>  },<br>  "Developers": {<br>    "description": "Developers Team",<br>    "display_name": "Developers"<br>  }<br>}</pre> | no |

...
| <a name="input_slack_notifications_channel"></a> [slack\_notifications\_channel](#input\_slack\_notifications\_channel) | If given, the Slack channel for deployment notifications. If not given, Slack notifications will not be enabled. | `string` | `""` | no |

...
| <a name="input_is_automation_repo"></a> [is\_automation\_repo](#input\_is\_automation\_repo) | Whether or not this is an automation repository. Will configure branch protection for GitHub bot/app. | `bool` | `true` | no |

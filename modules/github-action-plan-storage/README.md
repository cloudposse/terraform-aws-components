...
| <a name="input_oidc_provilder_stage"></a> [oidc\_provilder\_stage](#input\_oidc\_provilder\_stage) | OIDC provider stage | `string` | `"identity"` | no |
...
| <a name="output_tfstate_backend_s3_bucket_id"></a> [tfstate\_backend\_s3\_bucket\_id](#output\_tfstate\_backend\_s3\_bucket\_id) | Terraform state S3 bucket name |

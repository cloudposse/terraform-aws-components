...
--- | --- | --- | ---
`account_map` | 1.4.3 | [`cloudposse/stack-config/yaml//modules/remote-state`](https://registry.terraform.io/modules/cloudposse/stack-config/yaml/modules/remote-state/1.4.3) | n/a
...
<dl>
  ...
  <dt>`auto_enable_ec2` (`bool`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`auto_enable_ecr` (`bool`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`auto_enable_lambda` (`bool`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`member_association_excludes` (`list(string)`) <i>optional</i></dt>
  <dd>

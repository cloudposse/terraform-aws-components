...
| <a name="input_wait_for_capacity_timeout"></a> [wait\_for\_capacity\_timeout](#input\_wait\_for\_capacity\_timeout) | The maximum duration to wait for the bastion autoscaling group to become healthy | `string` | n/a | yes |

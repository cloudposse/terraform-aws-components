...
| <a name="input_capacity_timeout"></a> [capacity\_timeout](#input\_capacity\_timeout) | The maximum duration to wait for the bastion autoscaling group to become healthy | `string` | n/a | yes |

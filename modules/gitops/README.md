...
<dl>
  <dt>`dynamodb_component_name` (`string`) <i>optional</i></dt>
  <dd>
    The name of the dynamodb component used to store Terraform state<br/>
    <br/>
    **Type:** `string`
    <br/>
    **Default value:** `"gitops/dynamodb"`
  </dd>
  <dt>`dynamodb_environment_name` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`s3_bucket_component_name` (`string`) <i>optional</i></dt>
  <dd>
    The name of the s3_bucket component used to store Terraform state<br/>
    <br/>
    **Type:** `string`
    <br/>
    **Default value:** `"gitops/s3-bucket"`
  </dd>
  <dt>`s3_bucket_environment_name` (`string`) <i>optional</i></dt>
  <dd>

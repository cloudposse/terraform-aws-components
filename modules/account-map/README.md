...
| <a name="input_artifacts_account_account_name"></a> [artifacts\_account\_account\_name](#input\_artifacts\_account\_account\_name) | The name (usually `stage` or `tenant-stage`) of the artifacts account | `string` | `"artifacts"` | no |
| <a name="input_attributes"></a> [attributes](#input\_attributes) | ID element. Additional attributes (e.g. `workers` or `cluster`) to add to `id`,<br>in the order they appear in the list. New attributes are appended to the<br>end of the list. The elements of the list are joined by the `delimiter`<br>and treated as a single ID element. | `list(string)` | `[]` | no |
| <a name="input_audit_account_account_name"></a> [audit\_account\_account\_name](#input\_audit\_account\_account\_name) | The name (usually `stage` or `tenant-stage`) of the audit account | `string` | `"audit"` | no |
...
| <a name="input_dns_account_account_name"></a> [dns\_account\_account\_name](#input\_dns\_account\_account\_name) | The name (usually `stage` or `tenant-stage`) of the primary DNS account | `string` | `"dns"` | no |
...
| <a name="input_root_account_account_name"></a> [root\_account\_account\_name](#input\_root\_account\_account\_name) | The name (usually `stage` or `tenant-stage`) of the root account | `string` | `"root"` | no |

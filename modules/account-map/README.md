...
<dl>
  ...
  <dt>`aws_config_identity_profile_name` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`legacy_terraform_uses_admin` (`bool`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`terraform_dynamic_role_enabled` (`bool`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`terraform_role_name_map` (`map(string)`) <i>optional</i></dt>
  <dd>
...
<dl>
  ...
  <dt>`cicd_profiles` <strong>OBSOLETE</strong></dt>
  <dd>
    dummy results returned to avoid breaking code that depends on this output<br/>
  </dd>
  <dt>`cicd_roles` <strong>OBSOLETE</strong></dt>
  <dd>
    dummy results returned to avoid breaking code that depends on this output<br/>
  </dd>
  ...
  <dt>`helm_profiles` <strong>OBSOLETE</strong></dt>
  <dd>
    dummy results returned to avoid breaking code that depends on this output<br/>
  </dd>
  <dt>`helm_roles` <strong>OBSOLETE</strong></dt>
  <dd>
    dummy results returned to avoid breaking code that depends on this output<br/>
  </dd>
  ...
  <dt>`terraform_dynamic_role_enabled`</dt>
  <dd>

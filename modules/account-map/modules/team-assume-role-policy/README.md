...
| <a name="module_github_oidc_provider"></a> [github\_oidc\_provider](#module\_github\_oidc\_provider) | cloudposse/stack-config/yaml//modules/remote-state | 0.22.3 |
...
| <a name="input_deny_users"></a> [deny\_users](#input\_deny\_users) | False if you would like IAM Users to be able to assume the role. | `bool` | `true` | no |

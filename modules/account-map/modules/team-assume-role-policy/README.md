...
<dl>
  <dt>`allowed_permission_sets` (`map(list(string))`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`allowed_principal_arns` (`list(string)`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`allowed_roles` (`map(list(string))`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`denied_permission_sets` (`map(list(string))`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`denied_principal_arns` (`list(string)`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`denied_roles` (`map(list(string))`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`iam_users_enabled` (`bool`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`trusted_github_org` (`string`) <i>optional</i></dt>
  <dd>
  ...
  <dt>`trusted_github_repos` (`list(string)`) <i>optional</i></dt>
  <dd>
